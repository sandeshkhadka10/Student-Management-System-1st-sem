    ...
    while (1)
    {
        ...
        while (1) 
        {
            ...
            switch (choice) 
            {
                ...
                case 'f':
                    printf("\t\tPress (Y/y) to exit and any other character to cancel: ");
                    fflush(stdin);
                    scanf(" %c", &x); 
                    if (x == 'Y' || x == 'y')
                    {
                ...
                default:
                    ...
                    printf("\t\tPress any key to go to menu page........");
                    getch();
                    goto flag;
            }
...
void AddStudent()
{
    ...
    do
    {
        ...
        printf("\n\t\tDo you want to add another record?((Y/y)/any other character): ");
        fflush(stdin);
        scanf(" %c", &another);
    } 
